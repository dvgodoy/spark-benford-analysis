...
package object util {
  ...
  */
  ...
  protected[benford] def parseDouble(s: String): Option[Double] = Try { abs(s.toDouble) }.toOption
  ...
  type DataByLevelMsg = DataByLevel Or Every[ErrorMessage]
  type BasicBootMsg = BasicBoot Or Every[ErrorMessage]
  type DataStatsMsg = RDD[((Long, Int), StatsDigits)] Or Every[ErrorMessage]
  type StatsCIByLevelMsg = RDD[StatsCIByLevel] Or Every[ErrorMessage]
  type ResultsByLevelMsg = RDD[ResultsByLevel] Or Every[ErrorMessage]

  /*
  #
  # Function erfinv replicated from org.apache.commons.math3 due to depedency issues with Spark
  #
  */
  ...
  /*
  #
  # Function icdf replicated from org.apache.commons.math3 due to depedency issues with Spark
  #
  */
  ...
  /*
  #
  # Function erf replicated from org.apache.commons.math3 due to depedency issues with Spark
  #
  */
  ...
  /*
  #
  # Function cdf replicated from org.apache.commons.math3 due to depedency issues with Spark
  #
  */
